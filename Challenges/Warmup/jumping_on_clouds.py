...
# the number of the current cloud plus 1 or 2. The player must avoid the 
# thunderheads. Determine the minimum number of jumps it will take to 
# jump from the starting postion to the last cloud. It is always possible 
# to win the game.
#
...
# the player must avoid the clouds at indices 1 and 5. They could follow these 
...
# The second line contains  space-separated binary integers describing 
